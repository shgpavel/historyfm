...
\begin{frame}{Controlling the Infinite With the Finite}
        One technical lemma does the heavy lifting the
        \emph{Archimedean halving property}, attributed to Eudoxus and
        preserved in Euclid:
        ...
        \begin{columns}
                \begin{column}{0.55\textwidth}
                        ...
                        \vspace{0.1cm}
                        The statement is \emph{finite}. Never ``as $n
                        \to \infty$.'' Rather: \textbf{for every
